#!/usr/bin/env python3
"""
BLE 广播包深度扫描器 v6.5 (终极全格式适配版 + Manufacturer ID 映射)
彻底适配截图中的 mac_vendors_database.json 键名格式。
新增：通过 manufacturer_data 中的 Company ID 识别 Apple、Microsoft、Google 等设备。
"""
...
class BLEScannerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("BLE 深度扫描仪 v6.5 (完美兼容全部 5 种数据库格式 + 厂商双保险)")
